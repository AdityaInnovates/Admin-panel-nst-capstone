    ...
    <>
      <nav>
        ...
        <div>
          ...
          <form className="mentors_list flex gap-[0.8rem] items-center" onSubmit={(form) => {
            form.preventDefault()
          }}>
            <div className="relative">
              ...
              <div className="absolute right-[1rem] top-1/2 translate-y-[-60%]">
                <img src="/play.svg" className="w-[0.8rem] invert rotate-90" alt="" />
              </div>
            </div>
